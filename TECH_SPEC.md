...
- принадлежность данных к веб-сайту;
- личности;
- банку;
- списки одноразовых кодов активации;
...
Перечисленные ниже функции необязательны к реализации, однако позволяют лучше оценить степень экспертизы исполнителя. Исполнитель может реализовать любое количество из представленных ниже функций:
