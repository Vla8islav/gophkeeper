...
func TestGophkeeperService_UpdateSecret_Success(t *testing.T) {
...
func TestGophkeeperService_UpdateSecret_NilID(t *testing.T) {
	ctrl := gomock.NewController(t)
	repository := mocks.NewMockGophkeeperRepository(ctrl)
	svc := gophkeeperService{repository: repository}
...
func TestGophkeeperService_UpdateSecret_PassesThroughErrors(t *testing.T) {
	tests := []struct {
		name    string
		repoErr error
	}{
